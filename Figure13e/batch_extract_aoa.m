...
%BATCH_EXTRACT_AOA  Figure13e env1 sensing track (same CIR as Figure10c).
%
...
% Default: 8RX only (trajectory / track error).
%
%   batch_extract_aoa
%   batch_extract_aoa('angles', 0, 'ports', 8)
    ...
    addParameter(p, 'ports', 8);
    addParameter(p, 'min_range_m', 2.05);  % paper Fig.13 / extract_aoa_from_angle_maps default
