 ...
 */
#ifndef LIBOPENSTM32L1_EXTI_H
#define LIBOPENSTM32L1_EXTI_H
...
//By using defines we loose type check but get rid of significant overhead
//todo: Maybe there is some way to get the code inline keeping type checks
 
//void exti_enable_interrupt(int extis);
#define exti_enable_interrupt(extis) (EXTI_IMR |= extis)
//void exti_disable_interrupt(int extis);
#define exti_disable_interrupt(extis) (EXTI_IMR &= ~extis)
//int exti_get_interrupt_mask(int extis);
#define exti_get_interrupt_mask(extis) (EXTI_IMR & extis)
//int exti_get_interrupt_status(int extis);
#define exti_get_interrupt_status(extis) (EXTI_PR & extis)
//void exti_clear_interrupt(int extis);
#define exti_clear_interrupt(extis) EXTI_PR=extis
//void exti_enable_event(int extis);
#define exti_enable_event(extis) (EXTI_EMR |= extis)
//void exti_disable_event(int extis);
#define exti_disable_event(extis) (EXTI_EMR &= ~extis)
//int exti_get_event_mask(int extis);
#define exti_get_event_mask(extis) (EXTI_EMR & extis)
//void exti_set_software_interrupt(int extis);
#define exti_set_software_interrupt(extis) (EXTI_SWIER = extis)

#ifdef __cplusplus
} // extern "C"
#endif

#endif /* LIBOPENSTM32L1_EXTI_H */
