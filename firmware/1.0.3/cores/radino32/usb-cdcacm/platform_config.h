...
#if !defined(USE_AGENTE) && !defined(USE_STM32L_DISCOVERY)
 #error "Missing define for board type"
...
#elif defined (USE_AGENTE) || defined (USE_STM32L_DISCOVERY)
 /* 
...
/* #define USB_USE_EXTERNAL_PULLUP */
  ...
  #define STM32L15_USB_CONNECT                syscfg_enable_usb_pullup()
  #define STM32L15_USB_DISCONNECT             syscfg_disable_usb_pullup()
