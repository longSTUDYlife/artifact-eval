...
The repository is public. After evaluation, this snapshot will
...
\begin{itemize}
  ...
  \item 3D-printed module shell: \path{3d_model/Shell.STL}
        ($\approx$47$\times$48$\times$47\,mm). Not used by the figure
        scripts.
  \item Optional testbed firmware: \path{firmware/}
        (modified In-Circuit radino32 core, sketch, CIR logger).
        See \path{firmware/README.md}. Not used by the figure scripts.
\end{itemize}
